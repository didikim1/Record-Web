	...
	<script type="text/javascript">
	 ...
	 $(document).ready(function(){
		...
		$("#btnSubmit").click(function(){
			...
			var step1Object = new Object();
			var step2Object = new Object();

			step1Object["wavDirPath"] 			= $("[name=1StepWavDirPath]").val();
			step1Object["wavFileName"] 			= $("[name=1StepWavFileName]").val();
			step1Object["arryUserPassword"] 	= $("[name=1StepArryUserPassword]").val();

			step2Object["wavDirPath"] 			= $("[name=2StepWavDirPath]").val();
			step2Object["wavFileName"] 			= $("[name=2StepWavFileName]").val();
			step2Object["arryUserPassword"] 	= $("[name=2StepArryUserPassword]").val();


			mainArray.push( step1Object );
			mainArray.push( step2Object );


			console.log(  JSON.stringify( mainArray  ) );

			$("[name=tts]").val( JSON.stringify( mainArray  ) );
			console.log( jQuery("[name=reqForm]").serialize() )
			...
			var params = jQuery("[name=reqForm]").serialize();
			 $.ajax({
		            url:'/arsauth/wavplay/Req0003.do',
		            data:params,
...
<input type="hidden" name="tts" value="" readonly="readonly"/>
    ...
    <tr>
        ...
        <td>
        	<select name="arsCommandNumber">
        		<option value="L8003">L8003</option>
        	</select>
        </td>
    </tr>
    <tr>
...
<td>
    ...
    <tr>
        <th scope="row">[1단계]Wav 디렉토리</th>
        <td><input type="text" name="1StepWavDirPath" value="albert/" readonly="readonly"/></td>
    </tr>
    <tr>
        <th scope="row">[1단계]Wav 파일명</th>
        <td><input type="text" name="1StepWavFileName" value="EX_TTS_MENT_INTRO_01" readonly="readonly"/></td>
    </tr>
    <tr>
        <th scope="row">[1단계]사용자입력값</th>
        <td><input type="text" name="1StepArryUserPassword" value="1,2,3" readonly="readonly"/></td>
    </tr>
    <tr>
        <th scope="row">[2단계]Wav 디렉토리</th>
        <td><input type="text" name="2StepWavDirPath" value="albert/" readonly="readonly"/></td>
    </tr>
    <tr>
        <th scope="row">[2단계]Wav 파일명</th>
        <td><input type="text" name="2StepWavFileName" value="EX_TTS_MENT_INTRO_01" readonly="readonly"/></td>
    </tr>
    <tr>
        <th scope="row">[2단계]사용자입력값</th>
        <td><input type="text" name="2StepArryUserPassword" value="1,2,3" readonly="readonly"/></td>
    </tr>
    <tr>
