package com.lab603.record.web.playhistory.act;
...
import com.lab603.record.web.playhistory.biz.PlayHistoryBiz;

@Controller
@RequestMapping("/playHistory")
public class PlayHistoryAct
{
	final String pagePrefix = "playHistory";

	private static final org.apache.log4j.Logger Logger = org.apache.log4j.Logger.getLogger(PlayHistoryAct.class.getName());

	@Resource(name="com.lab603.record.web.playhistory.biz.PlayHistoryBiz")
	PlayHistoryBiz mBiz;
