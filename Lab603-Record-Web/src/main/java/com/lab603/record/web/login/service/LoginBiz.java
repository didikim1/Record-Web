...
import com.lab603.record.web.mapper.login.LoginMapper;

@Service("com.lab603.record.web.login.service.LoginBiz")
public class LoginBiz
{
	private static final org.apache.log4j.Logger Logger = org.apache.log4j.Logger.getLogger(LoginBiz.class.getName());

	@Resource(name = "com.lab603.record.web.mapper.login.LoginMapper")
	LoginMapper mMapper;
