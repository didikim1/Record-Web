package com.lab603.record.web.playhistory.biz;
...
import com.lab603.record.web.mapper.playhistory.PlayHistoryMapper;

@Service("com.lab603.record.web.playhistory.biz.PlayHistoryBiz")
public class PlayHistoryBiz
{
	private static final org.apache.log4j.Logger Logger = org.apache.log4j.Logger
			.getLogger(PlayHistoryBiz.class.getName());

	@Resource(name = "com.lab603.record.web.mapper.playhistory.PlayHistoryMapper")
	PlayHistoryMapper mMapper;
