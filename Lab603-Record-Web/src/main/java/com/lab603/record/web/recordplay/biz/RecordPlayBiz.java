package com.lab603.record.web.recordplay.biz;
...
@Service("com.lab603.record.web.recordplay.biz.RecordPlayBiz")
public class RecordPlayBiz
{
	private static final org.apache.log4j.Logger Logger = org.apache.log4j.Logger.getLogger(RecordPlayBiz.class.getName());
